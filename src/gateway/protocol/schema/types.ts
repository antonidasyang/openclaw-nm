...
export type ModelsAddProviderParams = Static<typeof ModelsAddProviderParamsSchema>;
export type ModelsAddProviderResult = Static<typeof ModelsAddProviderResultSchema>;
